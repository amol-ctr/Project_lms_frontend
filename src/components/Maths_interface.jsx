...
import { mathQuestions } from './data/maths_pyq';

function Maths_interface() {

    return (

        <div>
            <h1 className=' text-center mt-4 font-bold text-2xl'>Maths Previous Year Questions</h1>
...
export default Maths_interface